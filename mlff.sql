...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2016 at 07:23 PM
...
('2016_10_24_001631_create_pools_table', 6),
('2016_10_24_012559_create_jobs_table', 7),
('2016_10_24_064232_create_failed_jobs_table', 8);
...
INSERT INTO `pools` (`id`, `user_id`, `created_at`, `updated_at`, `refer_id`) VALUES
(18, 43, '2016-10-25 17:45:52', '2016-10-25 17:45:52', NULL);
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `aoi`, `dob`, `gender`, `email`, `mobile`, `password`, `nok_fn`, `nok_ln`, `nok_pn`, `nok_add`, `bank_name`, `bank_account`, `account_no`, `user_code`, `remember_token`, `created_at`, `updated_at`, `active`, `ip`, `ban`, `refer`, `whorefer`, `wallet`, `name`, `ticketit_admin`, `ticketit_agent`, `location`, `category`) VALUES
(43, 'Francis', 'Ben-Adesokan', 'Farming', '10/04/1978', 'm', 'ftb_a@yahoo.co.uk', '08023028084', '$2y$10$FHJN0dP7Ni9GT..ccbeNzewNeIlgxOKkazsXRgknFS3WF4qEKMcPO', 'eunice', 'ogbemudia', '08023347145', '2 tunde popoola street ikorodu', 'Guaranty Trust Bank Plc', 'francis ben-adesokan', '0012345678', '43BR12Nt', NULL, '2016-10-25 17:45:52', '2016-10-25 17:45:52', 0, '::1', 0, '', NULL, '0', NULL, 0, 0, 'http://placehold.it/150x150', 1);
